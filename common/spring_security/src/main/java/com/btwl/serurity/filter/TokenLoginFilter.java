package com.btwl.serurity.filter;

import com.btwl.commonutils.ResponseUtil;
import com.btwl.commonutils.Ret;
import com.btwl.serurity.entity.SecurityUser;
import com.btwl.serurity.entity.User;
...
public class TokenLoginFilter extends UsernamePasswordAuthenticationFilter {
  ...
  protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res,
    ...
    ResponseUtil.out(res, Ret.ok().data("token", token));
  }
