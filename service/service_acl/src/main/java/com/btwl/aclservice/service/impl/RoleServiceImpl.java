...
import com.btwl.aclservice.entity.UserRole;
import com.btwl.aclservice.mapper.RoleMapper;
import com.btwl.aclservice.service.RoleService;
import com.btwl.aclservice.service.UserRoleService;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements RoleService {
  ...
  public Map<String, Object> findRoleByUserId(String userId) {
    ...
    List<String> existRoleList = existUserRoleList.stream().map(c -> c.getRoleId())
  ...
  public List<Role> selectRoleByUserId(String id) {
    ...
    List<String> roleIdList = userRoleList.stream().map(item -> item.getRoleId())
        .collect(Collectors.toList());
