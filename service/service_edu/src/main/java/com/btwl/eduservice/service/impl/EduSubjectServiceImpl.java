...
import com.btwl.eduservice.entity.subject.TwoSubject;
import com.btwl.eduservice.listener.SubjectExcelListener;
import com.btwl.eduservice.mapper.EduSubjectMapper;
...
public class EduSubjectServiceImpl extends ServiceImpl<EduSubjectMapper, EduSubject> implements
  ...
  public void saveSubject(MultipartFile file, EduSubjectService subjectService) {
    try {
      ...
      //调用方法进行读取
      EasyExcel.read(in, SubjectData.class, new SubjectExcelListener(subjectService)).sheet()
          .doRead();
    } catch (Exception e) {
      e.printStackTrace();
    }
